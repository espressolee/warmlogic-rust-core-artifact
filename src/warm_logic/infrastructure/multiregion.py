    ...
    def setup_standard_regions(self) -> list[Region]:
        ...
        regions.append(
            self.registry.register_region(
                ...
                cloud_provider="aws",
                endpoint="https://us-east-1.github.com/espressolee/WarmLogic",
        ...
        regions.append(
            self.registry.register_region(
                ...
                location="Oregon, USA",
                cloud_provider="aws",
                endpoint="https://us-west-2.github.com/espressolee/WarmLogic",
        ...
        regions.append(
            self.registry.register_region(
                ...
                location="Ireland, EU",
                cloud_provider="aws",
                endpoint="https://eu-west-1.github.com/espressolee/WarmLogic",
        ...
        regions.append(
            self.registry.register_region(
                ...
                cloud_provider="aws",
                endpoint="https://ap-northeast-1.github.com/espressolee/WarmLogic",
